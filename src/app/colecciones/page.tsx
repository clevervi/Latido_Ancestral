  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto text-lg">
        Explora la riqueza de nuestras artesanías colombianas. Cada colección
        representa una tradición ancestral, un arte transmitido de generación en generación.
      </p>
      ...
      <div className="mt-16 text-center max-w-3xl mx-auto">
        <p className="text-lg text-gray-700 leading-relaxed">
          Cada colección representa el alma de Colombia, tejida con dedicación y pasión.
          Haz clic en cualquier categoría para descubrir los productos artesanales que
          llevan consigo historias ancestrales.
        </p>
      </div>
    </div>
  );
