...
import ProductBadges from "./ProductBadges"; // asegúrate de que este componente exista
...
export default function ProductCard({
  ...
  return (
    <div
      className="card group relative overflow-hidden bg-white rounded-lg shadow-md"
